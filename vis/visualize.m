...
%     if i == 1
%         imwrite(imind, cm, 'imm15_R15_d50_border_500.gif','gif', 'Loopcount', inf, 'DelayTime', 0.1); 
%     else 
%         imwrite(imind, cm, 'imm15_R15_d50_border_500.gif','gif','WriteMode','append', 'DelayTime', 0.1); 
%     end 
end
